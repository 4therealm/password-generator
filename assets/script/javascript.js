...
function passwordCriteria() { // With each criteria added the if statements concatenate the approved characters into the password array.
  ...
  if (okToUseSpecialChars == false && okToUseLowercase == false && okToUseUppercase == false && okToUseNumbers == false) { // since the generator can make a password if none of the criteria are chosen this alerts the user and returns them to the first prompt.
